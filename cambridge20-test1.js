...
window.AZ_READING_DATA['cambridge20-test1'] = {
  "id": "cambridge20-test1",
  ...
  "passages": [
    ...
    },
    {
      ...
      "paragraphs": [
        ...
        "The good news, however, is that positive emotions, such as hope, are contagious too, and are powerful in inducing people to act to find solutions. Being aware of this information can help us frame our messages more effectively and become conscientious agents of change."
      ]
    }
  ],
  "questionGroups": [
    {
      ...
      "items": [
        {"num":1,"text":"There are other parrots that share the kakapo's inability to fly."},
        {"num":2,"text":"Adult kakapo produce chicks every year."},
        {"num":3,"text":"Adult male kakapo bring food back to nesting females."},
        {"num":4,"text":"The Polynesian rat was a greater threat to the kakapo than Polynesian settlers."},
        {"num":5,"text":"Kakapo were transferred from Rakiura Island to other locations because they were at risk from feral cats."},
        {"num":6,"text":"One Recovery Plan initiative that helped increase the kakapo population size was caring for struggling young birds."}
      ]
    },
    {
      "type": "fill",
      ...
      "boxTitle": "New Zealand's kākāpō",
      "items": [
        {"num":7,"before":"A type of parrot: diet consists of fern fronds, various parts of a tree and","after":""},
        {"num":8,"before":"nests are created in","after":", in which eggs are laid"},
        {"num":9,"before":"Arrival of Polynesian settlers: the","after":"of the kākāpō were used to make clothes"},
        {"num":10,"before":"Arrival of European colonisers:","after":"were an animal which they introduced that ate the kākāpō's food sources"},
        {"num":11,"before":"Protecting kākāpō: a definite sighting of female kākāpō on Rakiura Island was reported in the year","after":""},
        {"num":12,"before":"the Recovery Plan included an increase in","after":""},
        {"num":13,"before":"a current goal of the Recovery Plan is to maintain the involvement of","after":"in kākāpō protection"}
      ]
    },
    {
      "type": "match_single",
      ...
      "items": [
        {"num":14,"text":"reference to the research problems that arise from there being only a few surviving large elms"},
        {"num":15,"text":"details of a difference of opinion about the value of reintroducing elms to Britain"},
        {"num":16,"text":"reference to how Dutch elm disease was brought into Britain"},
        {"num":17,"text":"a description of the conditions that have enabled a location in Britain to escape Dutch elm disease"},
        {"num":18,"text":"reference to the stage at which young elms become vulnerable to Dutch elm disease"}
      ]
    },
    {
      "type": "match_single",
      ...
      "instructions": "Look at the following statements (Questions 19-23) and the list of people below.\nMatch each statement with the correct person, A, B or C.\nNB You may use any letter more than once.",
      "options": [{"letter":"A","text":"Matt Elliot"},{"letter":"B","text":"Karen Russell"},{"letter":"C","text":"Peter Bourne"}],
      "items": [
        {"num":19,"text":"If a tree gets infected with Dutch elm disease, the damage rapidly becomes visible."},
        {"num":20,"text":"It may be better to wait and see if the mature elms that have survived continue to flourish."},
        {"num":21,"text":"There must be an explanation for the survival of some mature elms."},
        {"num":22,"text":"We need to be aware that insects carrying Dutch elm disease are not very far away."},
        {"num":23,"text":"You understand the effect Dutch elm disease has had when you see evidence of how prominent the tree once was."}
      ]
    },
    {
      "type": "fill",
      ...
      "boxTitle": "Uses of a popular tree",
      "summary": [
        {"text":"For hundreds of years, the only tree that was more popular in Britain than elm was"},
        {"blank":24},
        ...
        {"blank":25},
        {"text":". Due to its strength, elm was often used for mining equipment and the Cutty Sark's"},
        {"blank":26},
        {"text":"was also constructed from elm."}
      ]
    },
    {
      "type": "mcq",
      ...
      "items": [
        {"num":27,"text":"In the first paragraph, the writer introduces the topic of the text by","options":[{"letter":"A","text":"defining some commonly used terms."},{"letter":"B","text":"questioning a widely held assumption."},{"letter":"C","text":"mentioning a challenge faced by everyone."},{"letter":"D","text":"specifying a situation which makes us most anxious."}]},
        {"num":28,"text":"What point does the writer make about firefighters in the second paragraph?","options":[{"letter":"A","text":"The regular changes of stress levels in their working lives make them ideal study subjects."},{"letter":"B","text":"The strategies they use to handle stress are of particular interest to researchers."},{"letter":"C","text":"The stressful nature of their job is typical of many public service professions."},{"letter":"D","text":"Their personalities make them especially well-suited to working under stress."}]},
        {"num":29,"text":"What is the writer doing in the fourth paragraph?","options":[{"letter":"A","text":"explaining their findings"},{"letter":"B","text":"justifying their approach"},{"letter":"C","text":"setting out their objectives"},{"letter":"D","text":"describing their methodology"}]},
        {"num":30,"text":"In the seventh paragraph, the writer describes a mechanism in the brain which","options":[{"letter":"A","text":"enables people to respond more quickly to stressful situations."},{"letter":"B","text":"results in increased ability to control our levels of anxiety."},{"letter":"C","text":"produces heightened sensitivity to indications of external threats."},{"letter":"D","text":"is activated when there is a need to communicate a sense of danger."}]}
      ]
    },
    {
      "type": "match_single",
      ...
      "options": [{"letter":"A","text":"made them feel optimistic."},{"letter":"B","text":"took relatively little notice of bad news."},{"letter":"C","text":"responded to negative and positive information in the same way."},{"letter":"D","text":"were feeling under stress."},{"letter":"E","text":"put them in a stressful situation."},{"letter":"F","text":"behaved in a similar manner, regardless of the circumstances."},{"letter":"G","text":"thought it more likely that they would experience something bad."}],
      "items": [
        {"num":31,"text":"At times when they were relaxed, the firefighters usually ......."},
        {"num":32,"text":"The researchers noted that when the firefighters were stressed, they ......."},
        {"num":33,"text":"When the firefighters were told good news, they always ......."},
        {"num":34,"text":"The students' cortisol levels and heart rates were affected when the researchers ......."},
        {"num":35,"text":"In both experiments, negative information was processed better when the subjects ......."}
      ]
    },
    {
      "type": "tfng",
      ...
      "items": [
        {"num":36,"text":"The tone of the content we post on social media tends to reflect the nature of the posts in our feeds."},
        {"num":37,"text":"Phones have a greater impact on our stress levels than other electronic media devices."},
        {"num":38,"text":"The more we read about a stressful public event on social media, the less able we are to take in the information."},
        {"num":39,"text":"Stress created by social media posts can lead us to take unnecessary precautions."},
        {"num":40,"text":"Our tendency to be affected by other people's moods can be used in a positive way."}
      ]
    }
  ],
  "answerKey": {
...
window.AZ_READING_DATA['cambridge20-test1'].evidence = {
  "1": {"loc":"Đoạn 1","quote":"It is the world's only flightless parrot — kākāpō là vẹt duy nhất không biết bay, nên không có loài vẹt nào khác chia sẻ đặc điểm này."},
  "2": {"loc":"Đoạn 3","quote":"Kākāpō breed in summer and autumn, but only in years when food is plentiful — chỉ sinh sản khi thức ăn dồi dào, không phải hằng năm."},
  "3": {"loc":"Đoạn 3","quote":"Males play no part in incubation or chick-rearing - females alone incubate eggs and feed the chicks."},
  "4": {"loc":"Đoạn 4","quote":"With them came the Polynesian dog and rat, which also preyed on kākāpō — bài không so sánh mức độ đe doạ giữa chuột Polynesia và người định cư."},
  "5": {"loc":"Đoạn 7","quote":"Unfortunately, predation by feral cats on Rakiura Island led to a rapid decline in kākāpō numbers. As a result, during 1980-97, the surviving population was evacuated to three island sanctuaries"},
  "6": {"loc":"Đoạn 8","quote":"rescuing and hand-raising any failing chicks"},
  "7": {"loc":"Đoạn 2","quote":"their diet including the leaves, roots and bark of trees as well as bulbs, and fern fronds"},
  "8": {"loc":"Đoạn 3","quote":"The 1-4 eggs are laid in soil, which is repeatedly turned over before and during incubation"},
  "9": {"loc":"Đoạn 4","quote":"They ate its meat and used its feathers to make soft cloaks"},
  "10": {"loc":"Đoạn 4","quote":"introduced species such as deer depleted the remaining forests of food"},
  "11": {"loc":"Đoạn 6","quote":"There were about 200 individuals, and in 1980 it was confirmed females were also present"},
  "12": {"loc":"Đoạn 8","quote":"together with a specialist advisory group called the Kākāpō Scientific and Technical Advisory Committee and a higher amount of funding"},
  "13": {"loc":"Đoạn 10","quote":"ensure stakeholders continue to be fully engaged in the preservation of the species"},
  "14": {"loc":"Đoạn C","quote":"opportunities are limited as the number of these mature survivors is relatively small"},
  "15": {"loc":"Đoạn G","quote":"For her, the environmental case for reintroducing elm is strong ... Others are more wary"},
  "16": {"loc":"Đoạn B","quote":"in the '70s a second epidemic was triggered by shipments of elm from Canada"},
  "17": {"loc":"Đoạn E","quote":"Strong winds from the sea make it difficult for the determined elm bark beetle to attack this coastal city's elm population"},
  "18": {"loc":"Đoạn C","quote":"Once the trunk of the elm reaches 10-15 centimetres or so in diameter, it becomes a perfect size for beetles to lay eggs and for the fungus to take hold"},
  "19": {"loc":"Đoạn F","quote":"'The effects are very quick,' says Russell. 'You return in four to six weeks and trees that are resistant show no symptoms, whereas those that are susceptible show leaf loss and may even have died completely.'"},
  "20": {"loc":"Đoạn G","quote":"Sometimes the best thing you can do is just give nature time to recover, you might get resistance,' says Elliot"},
  "21": {"loc":"Đoạn C","quote":"I don't see how it can be entirely down to luck"},
  "22": {"loc":"Đoạn E","quote":"The beetles can just march in if we're not careful, as the threat is right on our doorstep,' says Bourne"},
  "23": {"loc":"Đoạn A","quote":"'The impact of the disease is difficult to picture if you hadn't seen what was there before,' says Matt Elliot"},
  "24": {"loc":"Đoạn D","quote":"elm ran a close second to oak as the hardwood tree of choice in Britain"},
  "25": {"loc":"Đoạn D","quote":"its wood was used for items such as storage crates and flooring"},
  "26": {"loc":"Đoạn D","quote":"used to build the keel of the 19th-century sailing ship Cutty Sark"},
  "27": {"loc":"Đoạn 1","quote":"we are all sometimes required to weigh up information under stressful conditions"},
  "28": {"loc":"Đoạn 2","quote":"These ups and downs presented the perfect setting for an experiment on how people's ability to use information changes when they feel under pressure"},
  "29": {"loc":"Đoạn 4","quote":"This is how we arrived at these results. We asked the firefighters to estimate their likelihood of experiencing 40 different adverse events in their life"},
  "30": {"loc":"Đoạn 7","quote":"a neural switch that automatically increases or decreases our ability to process warnings in response to changes in our environment could have been useful"},
  "31": {"loc":"Đoạn 5","quote":"they will ignore bad news and embrace the good. This is what happened when the firefighters were relaxed"},
  "32": {"loc":"Đoạn 5","quote":"they became hyper-vigilant to bad news, even when it had nothing to do with their job"},
  "33": {"loc":"Đoạn 5","quote":"stress didn't change how they responded to good news"},
  "34": {"loc":"Đoạn 5","quote":"students who were told they had to give a surprise public speech, which would be judged by a panel, recorded and posted online. Sure enough, their cortisol levels spiked, their heart rates went up"},
  "35": {"loc":"Đoạn 5","quote":"they suddenly became better at processing unrelated, yet alarming, information about rates of disease and violence"},
  "36": {"loc":"Đoạn 8","quote":"if we observe positive feeds on social media, such as images of a pink sunset, we are more likely to post uplifting messages ourselves. If we observe negative posts... we will in turn create more negative posts"},
  "37": {"loc":"Đoạn 9","quote":"Repeatedly checking your phone, according to a survey conducted by the American Psychological Association, is related to stress — không có so sánh với các thiết bị điện tử khác."},
  "38": {"loc":"Đoạn 10","quote":"which temporarily enhances the likelihood that people will take in negative reports, which increases stress further"},
  "39": {"loc":"Đoạn 10","quote":"trips are cancelled, even if the disaster took place across the globe; stocks are sold, even when holding on is the best thing to do"},
  "40": {"loc":"Đoạn 11","quote":"positive emotions, such as hope, are contagious too, and are powerful in inducing people to act to find solutions"}
};
