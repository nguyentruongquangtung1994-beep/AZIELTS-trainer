...
window.AZ_READING_DATA['cambridge20-test4'] = {
  "id": "cambridge20-test4",
  ...
  "passages": [
    {
      ...
      "paragraphs": [
        ...
        "O'Keeffe eventually owned two homes in New Mexico - the first, her summer home at Ghost Ranch, was nestled beneath 200-metre cliffs, while the second, used as her winter residence, was in the small town of Abiquiu. While both locales provided a wealth of imagery for her paintings, one feature of the Abiquiu house - the large walled patio with its black door - was particularly inspirational. In more than thirty pictures between 1946 and 1960, she reinvented the patio into an abstract arrangement of geometric shapes.",
  ...
  "questionGroups": [
    {
      ...
      "boxTitle": "The life and work of Georgia O'Keeffe",
      "items": [
        {"num":1,"before":"studied art, then worked as a","after":"in various places in the USA"},
        {"num":2,"before":"created drawings using","after":"which were exhibited in New York City"},
        {"num":3,"before":"moved to New York and became famous for her paintings of the city's","after":""},
        {"num":4,"before":"produced a series of innovative close-up paintings of","after":""},
        {"num":5,"before":"went to New Mexico and was initially inspired to paint the many","after":"that could be found there"},
        {"num":6,"before":"continued to paint various features that together formed the dramatic","after":"of New Mexico for over forty years"},
        {"num":7,"before":"travelled widely by plane in later years, and painted pictures of clouds and","after":"seen from above"}
      ]
    },
    {
      "type": "tfng",
      ...
      "items": [
        ...
        {"num":12,"text":"O'Keeffe's paintings of the patio of her house in Abiquiu were among the artist's favourite works."},
    ...
    },
    {
      ...
      "items": [
        {"num":18,"before":"The stormwater-management programme in Miami Beach has involved the installation of efficient","after":"."},
        {"num":19,"before":"The construction of","after":"was the first stage of a project to ensure the success of mangroves in Indonesia."},
        {"num":20,"before":"As a response to rising floodwaters in the Mekong Delta, a not-for-profit organisation has been building houses that can","after":"."},
        {"num":21,"before":"Rising sea levels in Bangladesh have made it necessary to introduce various","after":"that are suitable for areas of high salt content."},
        {"num":22,"before":"A project in LA has increased the number of","after":"on the city's streets."}
      ]
    },
    {
      "type": "match_single",
      ...
      "instructions": "Look at the following statements (Questions 23-26) and the list of people below.\nMatch each statement with the correct person, A-E.",
      "options": [
      ...
      "items": [
        ...
        {"num":25,"text":"More work will need to be done in future decades to deal with the impact of rising water levels."},
    ...
    },
    {
      ...
      "instructions": "Look at the following statements (Questions 32-36) and the list of people below.\nMatch each statement with the correct person, A-E.",
      "options": [
        {"letter":"A","text":"Dan Macon"},
        {"letter":"B","text":"Silvia Ribeiro"},
        {"letter":"C","text":"Linda van Bommel"},
        {"letter":"D","text":"Julie Young"},
        {"letter":"E","text":"Bethany Smith"}
      ],
      "items": [
    ...
    },
    {
      ...
      "boxTitle": "Unintended ecological effects of using guard dogs",
      "summary": [
  ...
  "answerKey": {
    "1":"teacher","2":"charcoal","3":"skyscrapers","4":"flowers","5":"bones","6":"landscape","7":"rivers",
    "8":"FALSE","9":"TRUE","10":"FALSE","11":"TRUE","12":"NOT GIVEN","13":"NOT GIVEN",
    "14":"C","15":"A","16":"D","17":"F",
    "18":"pumps","19":"dams","20":"float","21":"crops","22":"trees",
    "23":"B","24":"E","25":"A","26":"C",
    "27":"D","28":"G","29":"B","30":"C","31":"B",
    "32":"D","33":"E","34":"B","35":"C","36":"A",
    "37":"jackals","38":"diseases","39":"food","40":"foxes"
  },
  "scoreBands": [
...
window.AZ_READING_DATA['cambridge20-test4'].evidence = {
  "1": {"loc":"Đoạn 2","quote":"she became an art teacher and taught in elementary schools, high schools, and colleges in Virginia, Texas, and South Carolina"},
  "2": {"loc":"Đoạn 3","quote":"began to experiment with creating abstract compositions in charcoal"},
  "3": {"loc":"Đoạn 5","quote":"widely known for the architectural pictures that dramatically depict the soaring skyscrapers of New York"},
  "4": {"loc":"Đoạn 5","quote":"her magnified images depicting flowers, begun in 1924"},
  "5": {"loc":"Đoạn 8","quote":"it was the numerous sun-bleached bones she came across in the state's rugged terrain that sparked her imagination"},
  "6": {"loc":"Đoạn 9","quote":"it was the region's spectacular landscape, with its unusual geological formations, vivid colours, clarity of light, and exotic vegetation, that held the artist's imagination for more than four decades"},
  "7": {"loc":"Đoạn 11","quote":"aerial views of rivers and expansive paintings of the sky viewed from just above clouds"},
  "8": {"loc":"Đoạn 1","quote":"she remained independent from shifting art trends and her work stayed true to her own vision"},
  "9": {"loc":"Đoạn 2","quote":"By the time she graduated from high school in 1905, she had determined to make her way as an artist"},
  "10": {"loc":"Đoạn 3","quote":"She sent some of these drawings to a friend in New York, who showed them to art collector and photographer Alfred Stieglitz"},
  "11": {"loc":"Đoạn 4","quote":"Stieglitz's celebrated black-and-white portraits of O'Keeffe, taken over the course of twenty years (1917-37)"},
  "12": {"loc":"Đoạn 10","quote":"the large walled patio with its black door - was particularly inspirational"},
  "13": {"loc":"Đoạn 11","quote":"From the 1950s into the 1970s, O'Keeffe travelled widely, making trips to Asia, the Middle East, and Europe"},
  "14": {"loc":"Đoạn C","quote":"ecosystems of trees and shrubs that help defend coastal areas by trapping sediment in their net-like root systems"},
  "15": {"loc":"Đoạn A","quote":"scientists forecasting that global warming would continue for around 40 years"},
  "16": {"loc":"Đoạn D","quote":"It's much cheaper than permanently elevating houses, English explains - about a third of what it would cost to completely replace a building's foundations"},
  "17": {"loc":"Đoạn F","quote":"Using a Geographic Information System data mapping tool, the programme identified streets with low tree canopy cover"},
  "18": {"loc":"Đoạn B","quote":"the city has set up new pumps that can remove up to 75,000 litres of water per minute"},
  "19": {"loc":"Đoạn C","quote":"building semi-permeable dams, made from bamboo poles and brushwood, to mimic the role of mangrove roots"},
  "20": {"loc":"Đoạn D","quote":"these ones had been built to float"},
  "21": {"loc":"Đoạn E","quote":"start cultivating naturally salt-tolerant crops in the region"},
  "22": {"loc":"Đoạn F","quote":"the planting of trees and the installation of a 'cool pavement' system"},
  "23": {"loc":"Đoạn C","quote":"it's critical that we transition towards multifunctional approaches that embed natural infrastructure and engage the communities who depend on it"},
  "24": {"loc":"Đoạn F","quote":"Urban cooling is literally a matter of life and death for our future in LA"},
  "25": {"loc":"Đoạn B","quote":"We know that in 20, 30, 40 years, we'll need to go back in there and adjust to the changing environment"},
  "26": {"loc":"Đoạn D","quote":"climate change was not on the tip of everybody's tongue, but this technology is becoming necessary in places that didn't previously need it"},
  "27": {"loc":"Đoạn D","quote":"When guard dogs were introduced, more than 90 per cent of farmers reported a dramatic reduction in livestock losses, and said that as a result they were less likely to kill predators"},
  "28": {"loc":"Đoạn G","quote":"there may be a bright future for guard dogs in promoting harmonious coexistence between humans and wildlife"},
  "29": {"loc":"Đoạn B","quote":"The dogs will place themselves between the livestock and any threat, barking loudly"},
  "30": {"loc":"Đoạn C","quote":"more than 90 per cent of the farmers participating in a programme to train and use guard dogs to protect their herds against attack from wolves rate the performance of the dogs as very good or excellent"},
  "31": {"loc":"Đoạn B","quote":"Their initial training is to make them understand that livestock is going to be their life"},
  "32": {"loc":"Đoạn D","quote":"If ranchers don't have a dead cow, they will not make a call to apply for a permit to kill a wolf"},
  "33": {"loc":"Đoạn E","quote":"warned that such self-reported results must be taken with a pinch of salt"},
  "34": {"loc":"Đoạn E","quote":"If we are not working with everybody, we are transferring the wolf pressure to the neighbour's herd and he can use poison and kill an entire pack of wolves"},
  "35": {"loc":"Đoạn C","quote":"If they are managed and used properly, livestock guard dogs are the most efficient control method that we have in terms of the amount of livestock that they save from predation"},
  "36": {"loc":"Đoạn B","quote":"too much human affection makes it a great dog for guarding the front porch, rather than a great livestock guard dog"},
  "37": {"loc":"Đoạn F","quote":"the number of jackals killed by dogs and people actually increased"},
  "38": {"loc":"Đoạn F","quote":"spread diseases to wild animals, including endangered Ethiopian wolves"},
  "39": {"loc":"Đoạn F","quote":"They may also compete with other carnivores for food"},
  "40": {"loc":"Đoạn G","quote":"their presence has been found to protect birds which build their nests on the ground in fields, where foxes would normally raid them"}
};
