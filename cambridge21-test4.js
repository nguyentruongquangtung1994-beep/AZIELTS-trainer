...
window.AZ_READING_DATA['cambridge21-test4'] = {
  "id": "cambridge21-test4",
  ...
  "questionGroups": [
    {
      ...
      "items": [
        {"num":1,"text":"Water hyacinth was introduced as a decorative plant in east Africa."},
        {"num":2,"text":"Fishermen took some water hyacinth plants to Lake Victoria."},
        {"num":3,"text":"It is now difficult to force boats through the thick water hyacinth on Lake Victoria."},
        {"num":4,"text":"Chemicals produced by the water hyacinth plants are affecting the numbers of fish in Lake Victoria."},
        {"num":5,"text":"Cooking with charcoal has been proved to be even worse for people's health than cooking with wood."},
        {"num":6,"text":"People found it impossible to remove much water hyacinth from Lake Victoria."},
        {"num":7,"text":"Scientists started investigating the possibility of using water hyacinth to generate biogas in the last century."}
      ]
    },
    {
      "type": "fill",
      ...
      "boxTitle": "Generating biogas for domestic use in Dunga",
      "items": [
        {"num":8,"before":"First, place water hyacinth together with some","after":"into a digester"},
        {"num":9,"before":"Leave the mixture until the","after":"is completed"},
        {"num":10,"before":"Capture the gas emitted by the digester and use","after":"to transport it to individual homes, then use the gas for cooking as well as making water fit for human consumption"}
      ]
    },
    {
      "type": "fill",
      ...
      "boxTitle": "Cooking with biogas in Dunga — Benefits for the women in the village of cooking with biogas",
      "items": [
        {"num":11,"before":"No need for them to spend so much","after":"collecting fuel"},
        {"num":12,"before":"They can focus on different tasks that bring in","after":"(they are also less likely to experience certain diseases connected to burning wood)"},
        {"num":13,"before":"Drawbacks of changing to biogas — the","after":"of the digesters is beyond the reach of most villages"}
      ]
    },
    {
      "type": "bank_fill",
      ...
      "boxTitle": "Multilingualism in Delhi",
      "bank": [
      ...
      "summary": [
        {"text":"The city of Delhi has a"},
        {"blank":14},
        {"text":"and as you walk through its streets you hear people speaking a variety of languages. Some of them have spent their entire life in Delhi, while others are"},
        {"blank":15},
        {"text":". Whether they have come from a"},
        {"blank":16},
        {"text":"or have travelled from the other side of India, they have all come in search of things such as improved"},
        {"blank":17},
        {"text":". A team of researchers led by Professor Ianthi Tsimpli of Cambridge University is collecting data on primary-age schoolchildren in Delhi and other Indian cities. The"},
        {"blank":18},
        {"text":"of the research is to discover why multilingual Indian schoolchildren do not experience"},
        {"blank":19},
        {"text":"to those that multilingual schoolchildren in Europe experience."}
      ]
    },
    {
      "type": "tfng",
      ...
      "instructions": "Do the following statements agree with the claims of the writer in Reading Passage 2?\nIn boxes 20-23 on your answer sheet, write",
      ...
      "items": [
        {"num":20,"text":"Ten-year-old Indian schoolchildren tend to perform better in literacy tests than in numeracy tests."},
        {"num":21,"text":"Tsimpli had problems convincing some female students to take part in the study."},
        {"num":22,"text":"Tsimpli and her team wanted to know if there is a connection between poor academic performance and being taught in an unfamiliar language."},
        {"num":23,"text":"The researchers have decided against investigating the impact teaching methodology may have on learning outcomes."}
      ]
    },
    {
      "type": "mcq",
      ...
      "items": [
        {"num":24,"text":"What point does the writer make about primary schools in India in the sixth paragraph?","options":[{"letter":"A","text":"Exposure to English outside of school is of limited benefit."},{"letter":"B","text":"Children learn English more easily when they are well motivated."},{"letter":"C","text":"Poor children may be disadvantaged further by being instructed in English."},{"letter":"D","text":"There is little consistency across schools with regard to instruction in English."}]},
        {"num":25,"text":"What is Tsimpli suggesting when she uses the phrase 'that ship has sailed'?","options":[{"letter":"A","text":"The findings of the report may be of little help to some Indian schoolchildren."},{"letter":"B","text":"Instruction in English could be better adapted to the needs of schoolchildren."},{"letter":"C","text":"Schools have had limited success in teaching English as a separate subject."},{"letter":"D","text":"It is too late to remove English completely as a language of instruction in schools."}]},
        {"num":26,"text":"In the eighth paragraph, what do we learn has surprised researchers?","options":[{"letter":"A","text":"Boys and girls from low socio-economic groups have similar general intelligence levels."},{"letter":"B","text":"The age at which children move into a slum does not affect their academic performance."},{"letter":"C","text":"Slum children and children from other urban poor backgrounds have similar life experiences."},{"letter":"D","text":"The literacy and numeracy skills of slum children are not lower than those of children from other urban poor backgrounds."}]}
      ]
    },
    {
      "type": "bank_fill",
      ...
      "summary": [
        {"text":"Peter Bellerby's plan to give his father a globe for his birthday was an unexpectedly"},
        {"blank":27},
        {"text":"for which he had to overcome"},
        {"blank":28},
        {"text":". He soon learnt that a straightforward"},
        {"blank":29},
        {"text":"would not be possible. Some"},
        {"blank":30},
        {"text":"that had been intended for"},
        {"blank":31},
        {"text":"were available, as were some expensive antique globes, but these were beyond his budget. He even travelled to places where people might still have the"},
        {"blank":32},
        {"text":", but Bellerby could not find what he wanted."}
      ]
    },
    {
      "type": "tfng",
      ...
      "labelHint": [["YES","if the statement agrees with the claims of the writer"],["NO","if the statement contradicts the claims of the writer"],["NOT GIVEN","if it is impossible to say what the writer thinks about this"]],
      "items": [
        {"num":33,"text":"The assumption today that people in the past knew very little about geography is correct."},
        {"num":34,"text":"Plato was criticised for saying the world was shaped like a leather ball."},
        {"num":35,"text":"The globe made by Crates of Mallus was an accurate representation of the known world."},
        {"num":36,"text":"Bellerby assumed he would have few problems locating a well-made globe."}
      ]
    },
    {
      "type": "mcq",
      ...
      "instructions": "Choose the correct letter, A, B, C or D.",
      "items": [
        {"num":37,"text":"When Bellerby had to attach the gores to the globe surface,","options":[{"letter":"A","text":"he decided it was best to work quickly."},{"letter":"B","text":"he became aware of an unexpected issue."},{"letter":"C","text":"he was worried about the quality of his materials."},{"letter":"D","text":"he nearly gave up the whole project."}]},
        {"num":38,"text":"The reviewer mentions other globe makers of the past because","options":[{"letter":"A","text":"Bellerby was particularly inspired by them."},{"letter":"B","text":"their achievements are not widely known."},{"letter":"C","text":"Bellerby had something in common with each of them."},{"letter":"D","text":"their difficulties could have been avoided."}]},
        {"num":39,"text":"What point is made about Bellerby in the seventh paragraph?","options":[{"letter":"A","text":"He had long working relationships with numerous craftsmen."},{"letter":"B","text":"He understands the lack of interest in traditional crafts."},{"letter":"C","text":"He appreciates the importance of careful planning."},{"letter":"D","text":"He regrets the loss of many globe-making skills."}]},
        {"num":40,"text":"What does the reviewer say about Bellerby's book in the final paragraph?","options":[{"letter":"A","text":"It does not tell you how to create a profitable business."},{"letter":"B","text":"It overlooks some important mapmakers."},{"letter":"C","text":"It fails to discuss the future of globe-making."},{"letter":"D","text":"It does not give enough details about individual customers."}]}
      ]
    }
  ],
  "answerKey": {
    ...
    "20":"NO","21":"NOT GIVEN","22":"YES","23":"NO","24":"C","25":"D","26":"D",
    "27":"G","28":"J","29":"I","30":"C","31":"A","32":"E",
    "33":"NO","34":"NOT GIVEN","35":"NOT GIVEN","36":"YES","37":"B","38":"C","39":"D","40":"A"
  },
  "scoreBands": [
...
window.AZ_READING_DATA['cambridge21-test4'].evidence = {
  "1": {"loc":"Đoạn 2","quote":"who liked the look of its glossy leaves and delicate purple flowers floating in their ponds — được đưa vào làm cây cảnh trang trí"},
  "2": {"loc":"Đoạn 2","quote":"In east Africa the plant arrived with Belgian colonists in Rwanda — do thực dân Bỉ mang đến, không phải ngư dân"},
  "3": {"loc":"Đoạn 3","quote":"the boats that once brought the fish to shore by the hundreds struggle to navigate through the mass of plants — thuyền khó len qua lớp bèo dày"},
  "4": {"loc":"Đoạn 2","quote":"blocking fishing routes and providing a new habitat for disease-carrying mosquitoes — chỉ nói chặn đường đánh cá, không nói hoá chất ảnh hưởng số lượng cá (không có thông tin)"},
  "5": {"loc":"Đoạn 3","quote":"The World Health Organization estimates that about 14,300 Kenyans die annually as a result of indoor air pollution - most of which is caused by cooking and heating sources — không so sánh than củi với củi thường (không có thông tin)"},
  "6": {"loc":"Đoạn 4","quote":"huge piles of water hyacinth that villagers had taken out of the water in an attempt to clear it were a common sight — thực tế đã dọn được thành đống lớn, không phải bất khả thi"},
  "7": {"loc":"Đoạn 4","quote":"captivated researchers' imaginations since as early as the 1980s when, across the world, they began to explore its potential as a biofuel — bắt đầu từ thập niên 1980, tức thế kỷ trước"},
  "8": {"loc":"Đoạn 6","quote":"machines that would transform a mix of water hyacinth and cow dung into biogas for cooking"},
  "9": {"loc":"Đoạn 7","quote":"it goes through a fermentation process and breaks down"},
  "10": {"loc":"Đoạn 7","quote":"the clean-burning gas is passed through pipes to the point of use"},
  "11": {"loc":"Đoạn 8","quote":"they don't have to devote a lot of time every day to gathering firewood"},
  "12": {"loc":"Đoạn 8","quote":"they're able to make more money for their families from other enterprises"},
  "13": {"loc":"Đoạn 10","quote":"unless the price of the machines drops, it's pretty clear that most communities will never be able to afford any"},
  "14": {"loc":"Đoạn 1","quote":"more than 20 million people go about their daily lives — mật độ dân số đông đúc"},
  "15": {"loc":"Đoạn 1","quote":"many millions more have recently made India's capital their home, having moved from surrounding neighbourhoods, cities and states or across the country — người mới nhập cư"},
  "16": {"loc":"Đoạn 1","quote":"having moved from surrounding neighbourhoods, cities and states or across the country — khu vực lân cận"},
  "17": {"loc":"Đoạn 1","quote":"often in the hope of gaining better jobs and a better life — cơ hội việc làm"},
  "18": {"loc":"Đoạn 2","quote":"The overriding aim of the four-year project, called 'Multilingualism and Multiliteracy' — mục tiêu chính"},
  "19": {"loc":"Đoạn 2","quote":"the many benefits of speaking more than one language, observed in schools in Europe for instance, do not apply to many of India's schoolchildren — lợi ích tương tự học sinh châu Âu có được"},
  "20": {"loc":"Đoạn 3","quote":"over 50% of children in Standard 5 [ten-year-olds] cannot read a Standard 2 [seven-year-olds] task fluently, and just under 50% of them cannot solve a Standard 2 subtraction task — đọc kém hơn làm toán, ngược với nhận định trong câu hỏi"},
  "21": {"loc":"Đoạn 3","quote":"low educational achievement can lead to many of these students dropping out of school - a problem disproportionately affecting female students — chỉ nói về bỏ học, không nói về khó khăn tuyển học sinh nữ tham gia nghiên cứu (không có thông tin)"},
  "22": {"loc":"Đoạn 4","quote":"Tsimpli and her colleagues are investigating whether these low learning outcomes could be caused by an Indian school system where the language that children are taught in often differs from the language used at home"},
  "23": {"loc":"Đoạn 6","quote":"They intend to look not only at test results, but also at variables such as the standard of schooling, the environment and the teaching practices themselves — họ vẫn nghiên cứu phương pháp giảng dạy, không phải bỏ qua"},
  "24": {"loc":"Đoạn 7","quote":"the medium of instruction used in schools, especially English, may hold back those children who have little familiarity with, or exposure to, the language before starting school and outside of school life"},
  "25": {"loc":"Đoạn 8","quote":"We are not suggesting that English be withdrawn - that ship has sailed - but we perhaps have to think more about learner needs"},
  "26": {"loc":"Đoạn 9","quote":"children from slum backgrounds do not seem to lag behind children from other urban poor backgrounds - and in some cases outperform them (e.g. in numeracy and literacy tasks)"},
  "27": {"loc":"Đoạn 1","quote":"triggered an almost obsessive, decade-long journey — hành trình đầy thử thách"},
  "28": {"loc":"Đoạn 1","quote":"marked by a series of obstacles that would have deterred anyone less determined — vô số vấn đề"},
  "29": {"loc":"Đoạn 2","quote":"obtaining such a globe was not simply a matter of a quick online order and a repressed sigh at the shipping costs — mua qua mạng"},
  "30": {"loc":"Đoạn 3","quote":"Bellerby came across shoddy commercial versions designed for school classrooms — loại kém chất lượng"},
  "31": {"loc":"Đoạn 3","quote":"shoddy commercial versions designed for school classrooms — phục vụ mục đích giáo dục"},
  "32": {"loc":"Đoạn 3","quote":"where surely the knowledge of artisan cartographers* had been preserved — kỹ năng cần thiết"},
  "33": {"loc":"Đoạn 2","quote":"contrary to stubbornly held popular views of our ancestors' geographical ignorance, we have known that the world is spherical since at least the 6th century BCE — bài viết bác bỏ giả định đó (SAI)"},
  "34": {"loc":"Đoạn 2","quote":"The ancient Greek philosopher Plato in his work Phaedo likened it to a leather ball — không nói Plato bị chỉ trích (không có thông tin)"},
  "35": {"loc":"Đoạn 2","quote":"the accolade of producing the first recorded globe goes to the ancient Greek philosopher Crates of Mallus, who is said to have made one in around 150 BCE — không nói về độ chính xác (không có thông tin)"},
  "36": {"loc":"Đoạn 2","quote":"Surely, Bellerby reasoned, a good-quality globe wouldn't be difficult to find"},
  "37": {"loc":"Đoạn 7","quote":"Right at the end of the process, he learnt that the paper had stretched slightly and so the final one overlapped the first by a centimetre"},
  "38": {"loc":"Đoạn 8","quote":"Bellerby clearly found a kindred spirit in Martin Behaim"},
  "39": {"loc":"Đoạn 9","quote":"Bellerby's book is also a lament for the fading away of centuries-old traditions"},
  "40": {"loc":"Đoạn 10","quote":"is hardly a blueprint for commercial success"}
};
