...
window.AZ_READING_DATA['cambridge18-test4'] = {
  "id": "cambridge18-test4",
  ...
  "questionGroups": [
    {
      ...
      "options": [{"letter":"A"},{"letter":"B"},{"letter":"C"},{"letter":"D"},{"letter":"E"}],
      "items": [
        {"num":1,"text":"mention of several challenges to be overcome before a green roof can be installed"},
        {"num":2,"text":"reference to a city where green roofs have been promoted for many years"},
        {"num":3,"text":"a belief that existing green roofs should be used as a model for new ones"},
        {"num":4,"text":"examples of how green roofs can work in combination with other green urban initiatives"},
        {"num":5,"text":"the need to make a persuasive argument for the financial benefits of green roofs"}
      ]
    },
    {
      "type": "fill",
      ...
      "boxTitle": "Advantages of green roofs",
      "summary": [
        {"text":"City rooftops covered with greenery have many advantages. These include lessening the likelihood that floods will occur, reducing how much money is spent on"},
        {"blank":6},
        {"text":"and creating environments that are suitable for wildlife. In many cases, they can also be used for producing"},
        {"blank":7},
        {"text":". There are also social benefits of green roofs. For example, the medical profession recommends"},
        {"blank":8},
        {"text":"as an activity to help people cope with mental health issues. Studies have also shown that the availability of green spaces can prevent physical problems such as"},
        {"blank":9},
        {"text":"."}
      ]
    },
    {
      ...
      "options": [
        {"letter":"A","text":"a longer growing season for edible produce"},
        {"letter":"B","text":"more economical use of water"},
        {"letter":"C","text":"greater water-storage capacity"},
        {"letter":"D","text":"ability to cultivate more plant types"},
        {"letter":"E","text":"a large surface area for growing plants"}
      ]
    },
    {
      "type": "multi",
      ...
      "options": [
        {"letter":"A","text":"to provide habitats for a wide range of species"},
        {"letter":"B","text":"to grow plants successfully even in the wettest climates"},
        {"letter":"C","text":"to regulate the temperature of the immediate environment"},
        {"letter":"D","text":"to generate power from a sustainable source"},
        {"letter":"E","text":"to collect water to supply other buildings"}
      ]
    },
    {
      "type": "mcq",
      ...
      "items": [
        {"num":14,"text":"What can we learn from the first paragraph?","options":[{"letter":"A","text":"where the notion of innate intelligence first began"},{"letter":"B","text":"when ideas about the nature of intelligence began to shift"},{"letter":"C","text":"how scientists have responded to changing views of intelligence"},{"letter":"D","text":"why thinkers turned away from the idea of intelligence being fixed"}]},
        {"num":15,"text":"The second paragraph describes how schools encourage students to","options":[{"letter":"A","text":"identify their personal ambitions."},{"letter":"B","text":"help each other to realise their goals."},{"letter":"C","text":"have confidence in their potential to succeed."},{"letter":"D","text":"concentrate on where their particular strengths lie."}]},
        {"num":16,"text":"In the third paragraph, the writer suggests that students with a fixed mindset","options":[{"letter":"A","text":"tend to be less competitive."},{"letter":"B","text":"generally have a low sense of self-esteem."},{"letter":"C","text":"will only work hard if they are given constant encouragement."},{"letter":"D","text":"are afraid to push themselves beyond what they see as their limitations."}]}
      ]
    },
    {
      "type": "match_single",
      ...
      "instructions": "Look at the following statements (Questions 17-22) and the list of people below.\nMatch each statement with the correct person or people, A-E.\nWrite the correct letter, A-E, in boxes 17-22 on your answer sheet.\nNB You may use any letter more than once.",
      "options": [{"letter":"A","text":"Alfred Binet"},{"letter":"B","text":"Carol Dweck"},{"letter":"C","text":"Andrew Gelman"},{"letter":"D","text":"Timothy Bates"},{"letter":"E","text":"David Yeager and Gregory Walton"}],
      "items": [
        {"num":17,"text":"The methodology behind the growth mindset studies was not strict enough."},
        {"num":18,"text":"The idea of the growth mindset has been incorrectly interpreted."},
        {"num":19,"text":"Intellectual ability is an unchangeable feature of each individual."},
        {"num":20,"text":"The growth mindset should be promoted without students being aware of it."},
        {"num":21,"text":"The growth mindset is not simply about boosting students' morale."},
        {"num":22,"text":"Research shows that the growth mindset has no effect on academic achievement."}
      ]
    },
    {
      "type": "tfng",
      ...
      "instructions": "Do the following statements agree with the views of the writer in Reading Passage 2?\nIn boxes 23-26 on your answer sheet, write",
      ...
      "items": [
        {"num":23,"text":"Dweck has handled criticisms of her work in an admirable way."},
        {"num":24,"text":"Students' self-perception is a more effective driver of self-confidence than actual achievement is."},
        {"num":25,"text":"Recent evidence about growth mindset interventions has attracted unfair coverage in the media."},
        {"num":26,"text":"Deliberate attempts to encourage students to strive for high achievement may have a negative effect."}
      ]
    },
    {
      "type": "tfng",
      ...
      "items": [
        {"num":27,"text":"Wegener's ideas about continental drift were widely disputed while he was alive."},
        {"num":28,"text":"The idea that the continents remained fixed in place was defended in a number of respected scientific publications."},
        {"num":29,"text":"Wegener relied on a limited range of scientific fields to support his theory of continental drift."},
        {"num":30,"text":"The similarities between Wegener's theory of continental drift and modern-day plate tectonics are enormous."}
      ]
    },
    {
      "type": "bank_fill",
      ...
      "boxTitle": "Wegener's life and work",
      "bank": [
        {"letter":"A","text":"modest fame"},
        {"letter":"B","text":"vast range"},
        {"letter":"C","text":"record-breaking achievement"},
        {"letter":"D","text":"research methods"},
        {"letter":"E","text":"select group"},
        {"letter":"F","text":"professional interests"},
        {"letter":"G","text":"scientific debate"},
        {"letter":"H","text":"hazardous exploration"},
        {"letter":"I","text":"biographer's perspective"},
        {"letter":"J","text":"narrow investigation"}
      ],
      "summary": [
        {"text":"One of the remarkable things about Wegener from a"},
        {"blank":31},
        {"text":"is that although he proposed a theory of continental drift, he was not a geologist. His"},
        {"blank":32},
        {"text":"were limited to atmospheric physics. However, at the time he proposed his theory of continental drift in 1912, he was already a person of"},
        {"blank":33},
        {"text":". Six years previously, there had been his"},
        {"blank":34},
        {"text":"of 52 hours in a hot-air balloon, followed by his well-publicised but"},
        {"blank":35},
        {"text":"of Greenland's coast. With the publication of his textbook on thermodynamics, he had also come to the attention of a"},
        {"blank":36},
        {"text":"of German scientists."}
      ]
    },
    {
      "type": "mcq",
      ...
      "items": [
        {"num":37,"text":"What is Mott T Greene doing in the fifth paragraph?","options":[{"letter":"A","text":"describing what motivated him to write the book"},{"letter":"B","text":"explaining why it is desirable to read the whole book"},{"letter":"C","text":"suggesting why Wegener pursued so many different careers"},{"letter":"D","text":"indicating what aspects of Wegener's life interested him most"}]},
        {"num":38,"text":"What is said about Wegener in the sixth paragraph?","options":[{"letter":"A","text":"He was not a particularly ambitious person."},{"letter":"B","text":"He kept a record of all his scientific observations."},{"letter":"C","text":"He did not adopt many of the scientific practices of the time."},{"letter":"D","text":"He enjoyed discussing new discoveries with other scientists."}]},
        {"num":39,"text":"What does Greene say about some other famous scientists?","options":[{"letter":"A","text":"Their published works had a greater impact than Wegener's did."},{"letter":"B","text":"They had fewer doubts about their scientific ideas than Wegener did."},{"letter":"C","text":"Their scientific ideas were more controversial than Wegener's."},{"letter":"D","text":"They are easier subjects to write about than Wegener."}]},
        {"num":40,"text":"What is Greene's main point in the final paragraph?","options":[{"letter":"A","text":"It is not enough in life to have good intentions."},{"letter":"B","text":"People need to plan carefully if they want to succeed."},{"letter":"C","text":"People have little control over many aspects of their lives."},{"letter":"D","text":"It is important that people ensure they have the freedom to act."}]}
      ]
    }
  ],
  "answerKey": {
    "1":"D","2":"C","3":"E","4":"B","5":"D",
    "6":"energy","7":"food","8":"gardening","9":"obesity",
    "10_11":["C","D"],"12_13":["A","D"],
    "14":"B","15":"C","16":"D",
    "17":"C","18":"B","19":"A","20":"E","21":"B","22":"D",
    "23":"YES","24":"NO","25":"NOT GIVEN","26":"YES",
    "27":"YES","28":"NOT GIVEN","29":"NO","30":"NO",
    "31":"I","32":"F","33":"A","34":"C","35":"H","36":"E",
    "37":"B","38":"A","39":"D","40":"C"
  },
  "scoreBands": [
