...
window.AZ_READING_DATA['cambridge20-test3'] = {
  "id": "cambridge20-test3",
  ...
  "passages": [
    ...
    },
    {
      ...
      "paragraphs": [
        ...
        "In answer to the fourth question, 'What can science fiction tell us about robotics?', Rees replied, 'I sometimes advise students that it's better to read first-rate science fiction than second-rate science - it's more stimulating, and perhaps no more likely to be wrong.'",
  ...
  "questionGroups": [
    {
      ...
      "boxTitle": "The history of frozen food",
      "items": [
        {"num":1,"before":"2,000 years ago, South America - people conserved the nutritional value of","after":", using a method of freezing then drying."},
        {"num":2,"before":"1851, USA -","after":"was kept cool by ice during transportation in specially adapted trains."},
        {"num":3,"before":"1880, Australia - Two kinds of","after":"were the first frozen food shipped to England."},
        {"num":4,"before":"1917 onwards, USA - Clarence Birdseye introduced innovations including quick-freezing methods, so that","after":"did not spoil the food."},
        {"num":5,"before":"Also, packaging products with","after":", so the product was visible."},
        {"num":6,"before":"Early 1940s, USA - Frozen food became popular because of a shortage of","after":""},
        {"num":7,"before":"1950s, USA - A large number of homes now had a","after":""}
      ]
    },
    {
      "type": "tfng",
    ...
    },
    {
      ...
      "items": [
        {"num":24,"before":"Corals have a number of","after":"which they use to collect their food."},
        {"num":25,"before":"Algae gain","after":"from being inside the coral."},
        {"num":26,"before":"Increases in the warmth of the sea water can remove the","after":"from coral."}
      ]
    },
    {
      "type": "match_single",
      ...
      "instructions": "Look at the following statements (Questions 27-33) and the list of experts below.\nMatch each statement with the correct expert, A, B or C.\nNB You may use any letter more than once.",
      "options": [
        {"letter":"A","text":"Martin Rees"},
        {"letter":"B","text":"Daniel Wolpert"},
        {"letter":"C","text":"Kathleen Richardson"}
      ],
      "items": [
        ...
        {"num":32,"text":"The ideas in high-quality science fiction may prove to be just as accurate as those found in the work of mediocre scientists."},
    ...
    },
    {
      ...
      "instructions": "Complete each sentence with the correct ending, A-D, below.",
      "options": [
        {"letter":"A","text":"robots to explore outer space."},
        {"letter":"B","text":"advances made in machine intelligence so far."},
        {"letter":"C","text":"changes made to other planets for our own benefit."},
        {"letter":"D","text":"the harm already done by artificial intelligence."}
      ],
      "items": [
    ...
    },
    {
      ...
      "items": [
        {"num":37,"text":"What point does Richardson make about fear of machines?","options":[{"letter":"A","text":"It has grown alongside the development of ever more advanced robots."},{"letter":"B","text":"It is the result of our inclination to attribute human characteristics to non-human entities."},{"letter":"C","text":"It has its origins in basic misunderstandings about how inanimate objects function."},{"letter":"D","text":"It demonstrates a key difference between human intelligence and machine intelligence."}]},
        {"num":38,"text":"What potential advance does Rees see as a cause for concern?","options":[{"letter":"A","text":"robots outnumbering people"},{"letter":"B","text":"robots having abilities which humans do not"},{"letter":"C","text":"artificial intelligence developing independent thought"},{"letter":"D","text":"artificial intelligence taking over every aspect of our lives"}]},
        {"num":39,"text":"What does Wolpert emphasise in his response to the question about science fiction?","options":[{"letter":"A","text":"how science fiction influences our attitudes to robots"},{"letter":"B","text":"how fundamental robots are to the science fiction genre"},{"letter":"C","text":"how the image of robots in science fiction has changed over time"},{"letter":"D","text":"how reactions to similar portrayals of robots in science fiction may vary"}]},
        {"num":40,"text":"What is Richardson doing in her comment about reality and fantasy?","options":[{"letter":"A","text":"warning people not to confuse one with the other"},{"letter":"B","text":"outlining ways in which one has impacted on the other"},{"letter":"C","text":"recommending a change of approach in how people view them"},{"letter":"D","text":"explaining why scientists have a different perspective on them from other people"}]}
      ]
    }
  ],
  "answerKey": {
    "1":"potatoes","2":"butter","3":"meat","4":"crystals","5":"cellophane","6":"tin","7":"refrigerator",
    "8":"NOT GIVEN","9":"TRUE","10":"FALSE","11":"TRUE","12":"FALSE","13":"NOT GIVEN",
...
window.AZ_READING_DATA['cambridge20-test3'].evidence = {
  "1": {"loc":"Đoạn 1","quote":"had a unique means of conserving potatoes for later consumption"},
  "2": {"loc":"Đoạn 2","quote":"putting blocks of ice in insulated rail cars to send butter from Ogdensburg, New York, to Boston"},
  "3": {"loc":"Đoạn 4","quote":"they could export meat across the oceans"},
  "4": {"loc":"Đoạn 7","quote":"He developed quick-freezing techniques that reduced the damage that crystals caused"},
  "5": {"loc":"Đoạn 7","quote":"the use of cellophane, the first transparent material for food packaging, which allowed consumers to see the quality of the product"},
  "6": {"loc":"Đoạn 9","quote":"World War II gave a boost to the frozen food industry because tin was being used for munitions"},
  "7": {"loc":"Đoạn 9","quote":"By 1953, 33 million US families owned a refrigerator"},
  "8": {"loc":"Đoạn 2","quote":"ship owners from Boston, USA, had enormous blocks of Arctic ice towed all over the Atlantic for the purpose of food preservation — không nói họ giàu lên nhờ việc này"},
  "9": {"loc":"Đoạn 4","quote":"this spoilt the flavor and texture of the food"},
  "10": {"loc":"Đoạn 5","quote":"went to Labrador in Canada to trap and trade furs. While he was there, he became fascinated with how the Inuit would quickly freeze fish — đi vì buôn lông thú, không phải để học đông lạnh"},
  "11": {"loc":"Đoạn 10","quote":"with the help of a clever name and a huge advertising budget"},
  "12": {"loc":"Đoạn 10","quote":"served in the same segmented aluminum tray that was used by airlines — dùng lại khay có sẵn của hãng hàng không, không phải bao bì mới"},
  "13": {"loc":"Đoạn 11","quote":"the US frozen food industry has a turnover of over $67 billion annually — không so sánh với thế giới"},
  "14": {"loc":"Đoạn A","quote":"we want to show people how wonderful they are ... we also want to highlight the research and conservation efforts that are now being carried out to try to save them — hai mục tiêu: trưng bày vẻ đẹp và giới thiệu nỗ lực bảo tồn"},
  "15": {"loc":"Đoạn B","quote":"This comfortable symbiotic relationship has led to the growth of coral reefs — quan hệ hợp tác giữa polyp và tảo"},
  "16": {"loc":"Đoạn C","quote":"coral reefs are often described as the 'rainforests of the sea', though the comparison is dismissed by some naturalists"},
  "17": {"loc":"Đoạn D","quote":"scientists advise that more than 90% of reefs could be lost by 2050 unless urgent action is taken"},
  "18": {"loc":"Đoạn E","quote":"scientists are trying to pinpoint hardy types of coral that could survive our overheated oceans"},
  "19": {"loc":"Đoạn F","quote":"can be shown to the public and encourage them to believe that we can do something to save the planet's reefs"},
  "20_21": {"loc":"Đoạn D","quote":"pollution by humans, deoxygenation and ocean current changes — ô nhiễm (C) và thay đổi dòng chảy (E)"},
  "22_23": {"loc":"Đoạn E","quote":"to find those that can survive best in warm, acidic waters. Another will be to try to increase coral breeding rates"},
  "24": {"loc":"Đoạn B","quote":"polyps, with tentacles for capturing small marine creatures"},
  "25": {"loc":"Đoạn B","quote":"algae that live within them, which in turn get protection"},
  "26": {"loc":"Đoạn D","quote":"bleaching events that strip reefs of their colour"},
  "27": {"loc":"Đoạn 7","quote":"we should ensure that robots remain as no more than \"idiot savants\" lacking the capacity to outwit us"},
  "28": {"loc":"Đoạn 9","quote":"none have in fact risen up and challenged human supremacy"},
  "29": {"loc":"Đoạn 5","quote":"Expecting a machine close to the creative intelligence of a human within the next 50 years would be highly ambitious"},
  "30": {"loc":"Đoạn 4","quote":"Should we feel guilty about exploiting [sophisticated robots]? Should we fret if they are underemployed, frustrated, or bored? — Rees đặt câu hỏi về việc đối xử công bằng với robot"},
  "31": {"loc":"Đoạn 2","quote":"Using robots to gather resources nearer to home would seem to be a better use of our robotic tools"},
  "32": {"loc":"Đoạn 10","quote":"it's better to read first-rate science fiction than second-rate science - it's more stimulating, and perhaps no more likely to be wrong"},
  "33": {"loc":"Đoạn 9","quote":"Not all fear [robots]; many people welcome machine intelligence"},
  "34": {"loc":"Đoạn 3","quote":"the idea of 'colonisation' of other planets seemed morally dubious"},
  "35": {"loc":"Đoạn 5","quote":"In a limited sense it already has. Machines can already navigate, remember and search for items with an ability that far outstrips humans. However, there is no machine that can identify visual objects or speech with the reliability and flexibility of humans"},
  "36": {"loc":"Đoạn 8","quote":"we have already seen the damaging effects of artificial intelligence in the form of computer viruses"},
  "37": {"loc":"Đoạn 6","quote":"it stems from humans' tendency to personify inanimate objects: we create machines based on representations of ourselves"},
  "38": {"loc":"Đoạn 7","quote":"these could behave like a single \"brain\" with a mind of its own, and with goals that may be contrary to human welfare"},
  "39": {"loc":"Đoạn 11","quote":"almost no science fiction envisages a future without robots"},
  "40": {"loc":"Đoạn 12","quote":"we need to bring these different understandings together to get a whole perspective"}
};
