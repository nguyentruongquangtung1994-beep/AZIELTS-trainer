...
window.AZ_READING_DATA['cambridge21-test3'] = {
  "id": "cambridge21-test3",
  ...
  "passages": [
    ...
    },
    {
      ...
      "paragraphs": [
        ...
        "But Dar es Salaam is pinning its hopes on a solution that could offer a different model for Africa's megacities, giving them an alternative to a future controlled by the private car. Unlike many cities on the continent, Dar es Salaam isn't trying to build a metro. It has chosen a less exciting but cheaper and more achievable method: the bus. The DART bus rapid transit (BRT) system runs on bus lanes separated from other traffic, mostly in the middle of the road to reduce stoppages. Ticket purchase and control takes place at stations prior to boarding and the buses are step-free, which means the entire route is accessible to people using wheelchairs or who are travelling with baby buggies.",
  ...
  "questionGroups": [
    {
      ...
      "boxTitle": "The saiga",
      "items": [
        {"num":1,"before":"has a large bulbous nose with swollen nostrils that keep","after":"out"},
        {"num":2,"before":"lower the temperature of its","after":"in summer"},
        {"num":3,"before":"grows a thick","after":"in winter, which it loses in spring"},
        {"num":4,"before":"poaching, especially for the","after":"of male saiga"},
        {"num":5,"before":"expansion of farms and settlements, causing reduction in the size of the saiga's","after":""},
        {"num":6,"before":"loss of access to the","after":"which they use for migration"},
        {"num":7,"before":"climate change, causing the disappearance of","after":"which the saiga relied on"}
      ]
    },
    {
      "type": "tfng",
      ...
      "items": [
        {"num":8,"text":"Today, numbers of saiga are distributed evenly across four nations in Central Asia: Kazakhstan, Russia, Mongolia and Uzbekistan."},
        {"num":9,"text":"For most of the 20th century, the population of saiga were falling."},
        {"num":10,"text":"Efforts to protect rhinos in Africa had a significant effect on saiga populations."},
        {"num":11,"text":"Unpredictable fluctuations in climate are threatening the wildlife of Central Asia more than in other parts of the world."},
        {"num":12,"text":"The Altyn Dala Conservation Initiative was formed for the benefit of a number of different animals."},
        {"num":13,"text":"The Altyn Dala Conservation Initiative's recognition as a World Restoration Flagship project attracted additional international funding for the scheme."}
      ]
    },
    {
      "type": "tfng",
      ...
      "labelHint": [["TRUE","if the statement agrees with the information"],["FALSE","if the statement contradicts the information"],["NOT GIVEN","if there is no information on this"]],
      "items": [
        {"num":14,"text":"The population of Dar es Salaam is rising more rapidly than was previously predicted."},
        {"num":15,"text":"Most of the residents of Dar es Salaam live in high-rise blocks on the edge of the city."},
        {"num":16,"text":"Residents have been consulted about their views on the suburban rail line in Dar es Salaam."},
        {"num":17,"text":"The majority of the present residential development in Dar es Salaam is unplanned."},
        {"num":18,"text":"Dar es Salaam's authorities have decided to follow the public transport plan adopted by a large number of African cities."}
      ]
    },
    {
      "type": "fill",
      ...
      "instructions": "Complete the notes below.\nChoose ONE WORD ONLY from the passage for each answer.",
      "boxTitle": "Dar es Salaam's DART Bus Rapid Transit system",
      "items": [
        {"num":19,"before":"the buses use designated","after":"to cut down on delays"},
        {"num":20,"before":"passengers pay fares before","after":""},
        {"num":21,"before":"passengers in","after":"can use every part of the system"},
        {"num":22,"before":"the temperature control is sometimes not activated in order to reduce","after":"use"},
        {"num":23,"before":"insufficient number of vehicles are available due to the effects of a severe","after":""},
        {"num":24,"before":"passengers are unable to use","after":"because some equipment is out of action"},
        {"num":25,"before":"tickets have to be checked manually at station","after":""},
        {"num":26,"before":"","after":"frequently build up during rush hours"}
      ]
    },
    {
      "type": "mcq",
      ...
      "items": [
        {"num":27,"text":"What is the writer doing in the second paragraph?","options":[{"letter":"A","text":"pinpointing some key changes in our understanding of prehistory"},{"letter":"B","text":"outlining some aspects of prehistory which are still poorly understood"},{"letter":"C","text":"summarising some attitudes towards recent archaeological revelations"},{"letter":"D","text":"giving an overview of some current disagreements among archaeologists"}]},
        {"num":28,"text":"In the sixth paragraph, the writer mentions mobile phones to make the point that","options":[{"letter":"A","text":"most developments happen in a gradual way."},{"letter":"B","text":"innovation can come from a variety of sources."},{"letter":"C","text":"not all technological advancements are positive."},{"letter":"D","text":"the path of evolution can often be unpredictable."}]},
        {"num":29,"text":"In the seventh paragraph, the phrase 'unpick this stuff' refers to the task of","options":[{"letter":"A","text":"assessing the impact of certain recent research findings."},{"letter":"B","text":"questioning the authenticity of evidence used in earlier research."},{"letter":"C","text":"conducting research into how prehistoric societies were organised."},{"letter":"D","text":"reevaluating research influenced by outdated beliefs about society."}]},
        {"num":30,"text":"What does the writer suggest in the final paragraph?","options":[{"letter":"A","text":"Studying past societies could help us create a fairer society today."},{"letter":"B","text":"We should not judge past societies by the standards of modern society."},{"letter":"C","text":"We still have much to learn about how societies have evolved over history."},{"letter":"D","text":"There is more than one way to interpret evidence about societies in prehistoric times."}]}
      ]
    },
    {
      "type": "match_single",
      ...
      "options": [
        {"letter":"A","text":"Homo sapiens emerged at an earlier point in time than experts previously believed."},
        {"letter":"B","text":"previous assumptions about who had power in the prehistoric world were inaccurate."},
        {"letter":"C","text":"gender roles in extinct hominin species were different from those in Homo sapiens societies."},
        {"letter":"D","text":"experts may have been mistaken about who looked for food in early human communities."},
        {"letter":"E","text":"Homo sapiens was probably not the only species capable of sophisticated workmanship."},
        {"letter":"F","text":"other species managed to survive in harsh environments before the arrival of Homo sapiens."}
      ],
      "items": [
        {"num":31,"text":"The findings at Kalambo Falls revealed that"},
        {"num":32,"text":"Evidence from high-altitude regions suggests that"},
        {"num":33,"text":"An academic publication from June 2023 shows that"},
        {"num":34,"text":"Analysis of a 4000-year-old Iberian leader indicates that"}
      ]
    },
    {
      "type": "tfng",
      ...
      "items": [
        {"num":35,"text":"It seems likely that the Neanderthals' cave paintings were the first examples of artwork ever created."},
        {"num":36,"text":"It is very rare to find prehistoric artwork carved onto shells."},
        {"num":37,"text":"The methods which the researchers used to examine the Rising Star cave system were rather unconventional."},
        {"num":38,"text":"It is unclear how old the etchings in the Rising Star cave system are."},
        {"num":39,"text":"The means used to publicise the findings from the Rising Star cave system added to the controversy that surrounds them."},
        {"num":40,"text":"The size of H. naledi brains is a key factor in the question of whether these hominins were able to produce art."}
      ]
    }
  ],
  "answerKey": {
    "1":"dust","2":"blood","3":"coat","4":"horns","5":"habitat","6":"routes","7":"streams",
    "8":"FALSE","9":"FALSE","10":"TRUE","11":"NOT GIVEN","12":"TRUE","13":"NOT GIVEN",
    "14":"NOT GIVEN","15":"FALSE","16":"NOT GIVEN","17":"TRUE","18":"FALSE",
    "19":"lanes","20":"boarding","21":"wheelchairs","22":"fuel","23":"flood","24":"smartcards","25":"gates","26":"queues",
    "27":"A","28":"A","29":"D","30":"A","31":"E","32":"F","33":"D","34":"B",
...
window.AZ_READING_DATA['cambridge21-test3'].evidence = {
  "1": {"loc":"Đoạn 1","quote":"they filter out dust and cool the blood — nốt lọc bụi"},
  "2": {"loc":"Đoạn 1","quote":"they filter out dust and cool the blood during hot, dry summers — làm mát máu"},
  "3": {"loc":"Đoạn 1","quote":"a heavy winter coat that the saiga sheds when the weather warms up"},
  "4": {"loc":"Đoạn 3","quote":"their horns are highly prized by traditional medicine practitioners"},
  "5": {"loc":"Đoạn 4","quote":"Another threat to the survival of the saiga is loss of habitat"},
  "6": {"loc":"Đoạn 4","quote":"can block the seasonal migration routes of this transboundary species"},
  "7": {"loc":"Đoạn 6","quote":"many of the smaller streams that the species normally depended on have dried up and vanished"},
  "8": {"loc":"Đoạn 1","quote":"This country is estimated to be home to well over 90% of the global saiga population, with Russia, Mongolia and Uzbekistan accounting for the rest — phân bố không đều, tập trung chủ yếu ở Kazakhstan"},
  "9": {"loc":"Đoạn 2","quote":"numbers steadily recovered throughout most of the 20th century — trái với ý 'giảm suốt thế kỷ 20'"},
  "10": {"loc":"Đoạn 3","quote":"misguided conservationists tried to relieve the pressure on threatened African rhinos by actively encouraging the use of saiga horns in traditional medicine as an alternative to those of rhinos"},
  "11": {"loc":"Đoạn 6","quote":"saiga struggle to cope with temperature extremes and unpredictable fluctuations in climate — không so sánh với nơi khác trên thế giới"},
  "12": {"loc":"Đoạn 7","quote":"Its purpose is to protect and restore Kazakhstan's steppe, semi-desert and desert ecosystems and the many species they support"},
  "13": {"loc":"Đoạn 7","quote":"the United Nations recognised the initiative as a World Restoration Flagship project — không đề cập tới nguồn tài trợ quốc tế bổ sung"},
  "14": {"loc":"Đoạn 1","quote":"United Nations projections anticipate it will become a megacity within seven years — không so sánh với dự báo trước đây"},
  "15": {"loc":"Đoạn 2","quote":"four out of five of its people live in single-storey informal settlements"},
  "16": {"loc":"Đoạn 3","quote":"A single suburban rail line serves residents in a few areas to the south but is tiny in the context of the wider city — không nói tới việc tham vấn cư dân"},
  "17": {"loc":"Đoạn 4","quote":"Nearly all the expansion is happening on the periphery, and nearly all takes place informally without any agreed strategy"},
  "18": {"loc":"Đoạn 5","quote":"Unlike many cities on the continent, Dar es Salaam isn't trying to build a metro"},
  "19": {"loc":"Đoạn 5","quote":"The DART bus rapid transit (BRT) system runs on bus lanes separated from other traffic"},
  "20": {"loc":"Đoạn 5","quote":"Ticket purchase and control takes place at stations prior to boarding"},
  "21": {"loc":"Đoạn 5","quote":"the buses are step-free, which means the entire route is accessible to people using wheelchairs"},
  "22": {"loc":"Đoạn 6","quote":"drivers often refuse to turn on the air conditioning to save fuel"},
  "23": {"loc":"Đoạn 7","quote":"A shortage of buses after a serious flood at the main depot during the rainy season"},
  "24": {"loc":"Đoạn 7","quote":"Smartcards can't be used as the mechanical readers aren't working either"},
  "25": {"loc":"Đoạn 7","quote":"Staff stand by the gates and tear tickets as people enter"},
  "26": {"loc":"Đoạn 7","quote":"As a result, queues are considerable at peak times"},
  "27": {"loc":"Đoạn 2","quote":"Two things stand out to me. One is the growing evidence that many supposedly 'advanced' behaviours"},
  "28": {"loc":"Đoạn 6","quote":"Evolution usually works by incremental steps and so does technology. The first birds weren't great at flying, and the first mobile phones weren't great at"},
  "29": {"loc":"Đoạn 7","quote":"Archaeology was invented by individuals with now unfashionably patriarchal views about gender, and those notions fed into their research"},
  "30": {"loc":"Đoạn 9","quote":"Inequality, authoritarianism and patriarchy aren't inevitable. They're choices, and prehistory shows us that we can choose differently"},
  "31": {"loc":"Đoạn 3","quote":"researchers found buried logs that had been shaped with stone tools so that they interlocked ... That's almost 200,000 years before our species, Homo sapiens, evolved"},
  "32": {"loc":"Đoạn 3","quote":"extinct hominins such as the Denisovans lived on the frozen heights of high-altitude regions 200,000 years ago"},
  "33": {"loc":"Đoạn 8","quote":"a meta-analysis published in June 2023 compiled data on several dozen foraging societies and found women hunted in 80 per cent of them"},
  "34": {"loc":"Đoạn 8","quote":"an Iberian leader from around 4000 years ago turned out to be female, not male as many had assumed"},
  "35": {"loc":"Đoạn 4","quote":"We have had evidence for a long time now that Neanderthals painted on cave walls. Even earlier species, such as Homo erectus, may also have made art"},
  "36": {"loc":"Đoạn 4","quote":"Even earlier species, such as Homo erectus, may also have made art, for example by engraving patterns on shells — không nói là hiếm gặp"},
  "37": {"loc":"Đoạn 5","quote":"The dispute has only been heightened by the way the results were released, in a non-traditional journal that publishes peer reviews publicly alongside the paper"},
  "38": {"loc":"Đoạn 4","quote":"researchers have found what seem to be etchings - resembling rudimentary artwork - on the cave walls, though these have yet to be firmly dated"},
  "39": {"loc":"Đoạn 5","quote":"The dispute has only been heightened by the way the results were released, in a non-traditional journal that publishes peer reviews publicly alongside the paper"},
  "40": {"loc":"Đoạn 5","quote":"I think the species' small brains are a distraction"}
};
