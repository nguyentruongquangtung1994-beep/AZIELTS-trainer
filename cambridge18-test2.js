...
window.AZ_READING_DATA['cambridge18-test2'] = {
  "id": "cambridge18-test2",
  ...
  "questionGroups": [
    {
      ...
      "boxTitle": "Stonehenge",
      "items": [
        {"num":1,"before":"Construction – Stage 1: the ditch and henge were dug, possibly using tools made from","after":""},
        {"num":2,"before":"Stage 1:","after":"may have been arranged in deep pits inside the circle"},
        {"num":3,"before":"Stage 2 – theories about the transportation of the bluestones (archaeological): builders used","after":"to make sledges and rollers"},
        {"num":4,"before":"Stage 2 (archaeological):","after":"pulled them on giant baskets"},
        {"num":5,"before":"Stage 2 (geological): they were brought from Wales by","after":""},
        {"num":6,"before":"Builders – a theory arose in the 17th century that its builders were Celtic","after":""},
        {"num":7,"before":"Purpose – many experts agree it has been used as a","after":"site"},
        {"num":8,"before":"Purpose – in the 1960s, it was suggested that it worked as a kind of","after":""}
      ]
    },
    {
      "type": "tfng",
      ...
      "items": [
        {"num":9,"text":"During the third phase of construction, sandstone slabs were placed in both the outer areas and the middle of the Stonehenge site."},
        {"num":10,"text":"There is scientific proof that the bluestones stood in the same spot until approximately 1600 BCE."},
        {"num":11,"text":"John Aubrey's claim about Stonehenge was supported by 20th-century findings."},
        {"num":12,"text":"Objects discovered at Stonehenge seem to indicate that it was constructed by a number of different groups of people."},
        {"num":13,"text":"Criticism of Gerald Hawkins' theory about Stonehenge has come mainly from other astronomers."}
      ]
    },
    {
      "type": "mcq",
      ...
      "items": [
        {"num":14,"text":"What point does the writer make about AI in the first paragraph?","options":[{"letter":"A","text":"It is difficult to predict how quickly AI will progress."},{"letter":"B","text":"Much can be learned about the use of AI in chess machines."},{"letter":"C","text":"The future is unlikely to see limitations on the capabilities of AI."},{"letter":"D","text":"Experts disagree on which specialised tasks AI will be able to perform."}]},
        {"num":15,"text":"What is the writer doing in the second paragraph?","options":[{"letter":"A","text":"explaining why machines will be able to outperform humans"},{"letter":"B","text":"describing the characteristics that humans and machines share"},{"letter":"C","text":"giving information about the development of machine intelligence"},{"letter":"D","text":"indicating which aspects of humans are the most advanced"}]},
        {"num":16,"text":"Why does the writer mention the story of King Midas?","options":[{"letter":"A","text":"to compare different visions of progress"},{"letter":"B","text":"to illustrate that poorly defined objectives can go wrong"},{"letter":"C","text":"to emphasise the need for cooperation"},{"letter":"D","text":"to point out the financial advantages of a course of action"}]},
        {"num":17,"text":"What challenge does the writer refer to in the fourth paragraph?","options":[{"letter":"A","text":"encouraging humans to behave in a more principled way"},{"letter":"B","text":"deciding which values we want AI to share with us"},{"letter":"C","text":"creating a better world for all creatures on the planet"},{"letter":"D","text":"ensuring AI is more human-friendly than we are ourselves"}]},
        {"num":18,"text":"What does the writer suggest about the future of AI in the fifth paragraph?","options":[{"letter":"A","text":"The safety of machines will become a key issue."},{"letter":"B","text":"It is hard to know what impact machines will have on the world."},{"letter":"C","text":"Machines will be superior to humans in certain respects."},{"letter":"D","text":"Many humans will oppose machines having a wider role."}]},
        {"num":19,"text":"Which of the following best summarises the writer's argument in the sixth paragraph?","options":[{"letter":"A","text":"More intelligent machines will result in greater abuses of power."},{"letter":"B","text":"Machine learning will share very few features with human learning."},{"letter":"C","text":"There are a limited number of people with the knowledge to program machines."},{"letter":"D","text":"Human shortcomings will make creating the machines we need more difficult."}]}
      ]
    },
    {
      "type": "tfng",
      ...
      "items": [
        {"num":20,"text":"Machines with the ability to make moral decisions may prevent us from promoting the interests of our communities."},
        {"num":21,"text":"Silicon police would need to exist in large numbers in order to be effective."},
        {"num":22,"text":"Many people are comfortable with the prospect of their independence being restricted by machines."},
        {"num":23,"text":"If we want to ensure that machines act in our best interests, we all need to work together."}
      ]
    },
    {
      "type": "bank_fill",
      ...
      "instructions": "Complete the summary using the list of phrases, A-F, below.",
      "boxTitle": "Using AI in the UK health system",
      "bank": [
      ...
      "summary": [
        {"text":"AI currently has a limited role in the way"},
        {"blank":24},
        {"text":"are allocated in the health service. The positive aspect of AI having a bigger role is that it would be more efficient and lead to patient benefits. However, such a change would result, for example, in certain"},
        {"blank":25},
        {"text":"not having their current level of"},
        {"blank":26},
        {"text":". It is therefore important that AI goals are appropriate so that discriminatory practices could be avoided."}
      ]
    },
    {
      "type": "tfng",
      ...
      "labelHint": [["TRUE","if the statement agrees with the information"],["FALSE","if the statement contradicts the information"],["NOT GIVEN","if there is no information on this"]],
      "items": [
        {"num":27,"text":"People first referred to Leonardo da Vinci as a genius 500 years ago."},
        {"num":28,"text":"The current climate crisis is predicted to cause more deaths than the plague."},
        {"num":29,"text":"Some of the challenges we face today can be compared to those of earlier times."},
        {"num":30,"text":"Leonardo da Vinci's 'ideal city' was constructed in the 15th century."},
        {"num":31,"text":"Poor town planning is a major contributor to climate change."},
        {"num":32,"text":"In Renaissance times, local people fought against the changes to Pienza and Ferrara."},
        {"num":33,"text":"Leonardo da Vinci kept a neat, organised record of his designs."}
      ]
    },
    {
      "type": "fill",
      ...
      "boxTitle": "Leonardo da Vinci's ideal city",
      "summary": [
        {"text":"A collection of Leonardo da Vinci's paperwork reveals his design of a new city beside the Ticino River. This was to provide better"},
        {"blank":34},
        {"text":"for trade and a less polluted environment. Although Leonardo da Vinci's city shared many of the ideals of his time, some of his innovations were considered unconventional in their design. They included features that can be seen in some tower blocks today, such as"},
        {"blank":35},
        {"text":"on the exterior of a building."},
        {"text":"Leonardo da Vinci wasn't only an architect. His expertise in"},
        {"blank":36},
        {"text":"was evident in his plans for artificial canals within his ideal city. He also believed that the height of houses should relate to the width of streets in case earthquakes occurred. The design of many cities in Italy today follows this"},
        {"blank":37},
        {"text":"."},
        {"text":"While some cities from"},
        {"blank":38},
        {"text":"times have aspects that can also be found in Leonardo's designs, his ideas weren't put into practice until long after his death."},
        {"blank":39},
        {"text":"is one example of a city that was redesigned in the 19th century in the way that Leonardo had envisaged. His ideas are also relevant to today's world, where building"},
        {"blank":40},
        {"text":"no longer seems to be the best approach."}
      ]
    }
  ],
  "answerKey": {
    "1":"(deer) antlers","2":"(timber) posts","3":"tree trunks","4":"oxen","5":"glaciers","6":"druids","7":"burial","8":"calendar",
    "9":"TRUE","10":"FALSE","11":"FALSE","12":"TRUE","13":"NOT GIVEN",
    "14":"C","15":"A","16":"B","17":"D","18":"C","19":"D",
    "20":"YES","21":"NOT GIVEN","22":"NO","23":"YES",
    "24":"C","25":"A","26":"E",
