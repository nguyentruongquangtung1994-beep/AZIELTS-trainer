...
window.AZ_READING_DATA['cambridge18-test3'] = {
  "id": "cambridge18-test3",
  ...
  "questionGroups": [
    {
      ...
      "range": [1, 4],
      "title": "Questions 1-4",
      "instructions": "Reading Passage 1 has eight sections, A-H.\nWhich section contains the following information? Write the correct letter, A-H.",
      "options": [{"letter":"A"},{"letter":"B"},{"letter":"C"},{"letter":"D"},{"letter":"E"},{"letter":"F"},{"letter":"G"},{"letter":"H"}],
      "items": [
        {"num":1,"text":"an explanation of the industrial processes that create potential raw materials for concrete"},
        {"num":2,"text":"a reference to the various locations where high-rise wooden buildings can be found"},
        {"num":3,"text":"an indication of how widely available the raw materials of concrete are"},
        {"num":4,"text":"the belief that more high-rise wooden buildings are needed before wood can be regarded as a viable construction material"}
      ]
    },
    {
      "type": "fill",
      ...
      "summary": [
        {"text":"Wood is a traditional building material, but current environmental concerns are encouraging"},
        {"blank":5},
        {"text":"to use wood in modern construction projects. Using wood, however, has its challenges. For example, as"},
        {"blank":6},
        {"text":"in the atmosphere enters wood, it increases in size. In addition, wood is prone to pests and the risk of fire is greater. However, wood can be turned into a better construction material if it is treated and combined with other materials. In one process,"},
        {"blank":7},
        {"text":"of solid wood are glued together to create building blocks. These blocks are lighter than concrete and steel but equal them in strength. Experts say that wooden buildings are an improvement on those made of concrete and steel in terms of the"},
        {"blank":8},
        {"text":"with which they can be constructed and how much noise is generated by the process."}
      ]
    },
    {
      "type": "match_single",
      ...
      "instructions": "Look at the following statements (Questions 9-13) and the list of people below.\nMatch each statement with the correct person, A, B, C or D.\nNB You may use any letter more than once.",
      "options": [{"letter":"A","text":"Chris Cheeseman"},{"letter":"B","text":"Markus Mannström"},{"letter":"C","text":"Anna Surgenor"},{"letter":"D","text":"Felix Preston and Johanna Lehne"}],
      "items": [
        {"num":9,"text":"The environmental advantage of cement alternatives may not be as great as initially assumed."},
        {"num":10,"text":"It would be hard to create a construction alternative to concrete that offers so many comparable benefits."},
        {"num":11,"text":"Worries about the environment have led to increased interest in wood as a construction material."},
        {"num":12,"text":"Expense has been a factor in the negative response to the development of new cements."},
        {"num":13,"text":"The environmental damage caused by concrete is due to it being produced in large quantities."}
      ]
    },
    {
      "type": "match_single",
      ...
      "options": [
        {"letter":"i","text":"A period in cold conditions before the technology is assessed"},
        {"letter":"ii","text":"Marketing issues lead to failure"},
        {"letter":"iii","text":"Good and bad aspects of steam technology are passed on"},
        {"letter":"iv","text":"A possible solution to the issues of today"},
        {"letter":"v","text":"Further improvements lead to commercial orders"},
        {"letter":"vi","text":"Positive publicity at last for this quiet, clean, fast vehicle"},
        {"letter":"vii","text":"A disappointing outcome for customers"},
        {"letter":"viii","text":"A better option than the steam car arises"}
      ],
      "items": [
    ...
    },
    {
      ...
      "items": [
        {"num":21,"text":"What point does the writer make about the steam car in Paragraph B?","options":[{"letter":"A","text":"Its success was short-lived."},{"letter":"B","text":"Not enough cars were made."},{"letter":"C","text":"Car companies found them hard to sell."},{"letter":"D","text":"People found them hard to drive."}]},
        {"num":22,"text":"When building their first steam car, the Doble brothers","options":[{"letter":"A","text":"constructed all the parts themselves."},{"letter":"B","text":"made written notes at each stage of the construction."},{"letter":"C","text":"needed several attempts to achieve a competitive model."},{"letter":"D","text":"sought the advice of experienced people in the car industry."}]},
        {"num":23,"text":"In order to produce the Model C, the Doble brothers","options":[{"letter":"A","text":"moved production to a different city."},{"letter":"B","text":"raised financial capital."},{"letter":"C","text":"employed an additional worker."},{"letter":"D","text":"abandoned their earlier designs."}]}
      ]
    },
    {
      "type": "fill",
      ...
      "summary": [
        {"text":"The Model E was road-tested in 1924 by the Automobile Club of America. They found it easy to drive, despite its weight, and it impressed the spectators. A later version of the Model E raised its"},
        {"blank":24},
        {"text":", while keeping its emissions extremely low. The steam car was too expensive for many people and its design was constantly being altered. Under"},
        {"blank":25},
        {"text":"cars were produced before the company went out of business. However, even today, there are Model Es on the road in the US. They are straightforward to maintain, and they satisfy California's"},
        {"blank":26},
        {"text":"emissions laws. Perhaps today's technology and materials would help us revive the steam car."}
      ]
    },
    {
      "type": "mcq",
      ...
      "instructions": "Choose the correct letter, A, B, C or D.",
      "items": [
        {"num":27,"text":"The writer describes the Romeo and Juliet lesson in order to demonstrate","options":[{"letter":"A","text":"how few students are interested in literature."},{"letter":"B","text":"how a teacher handles a range of learning needs."},{"letter":"C","text":"how unsuitable Shakespeare is for most teenagers."},{"letter":"D","text":"how weaker students can disrupt their classmates' learning."}]},
        {"num":28,"text":"What does the writer say about streaming in the third paragraph?","options":[{"letter":"A","text":"It has a very broad appeal."},{"letter":"B","text":"It favours cleverer students."},{"letter":"C","text":"It is relatively simple to implement."},{"letter":"D","text":"It works better in some schools than others."}]},
        {"num":29,"text":"What idea is suggested by the reference to Mount Qomolangma in the fifth paragraph?","options":[{"letter":"A","text":"students following unsuitable paths"},{"letter":"B","text":"students attempting interesting tasks"},{"letter":"C","text":"students not achieving their full potential"},{"letter":"D","text":"students not being aware of their limitations"}]},
        {"num":30,"text":"What does the word 'scaffolding' in the sixth paragraph refer to?","options":[{"letter":"A","text":"the factors which prevent a student from learning effectively"},{"letter":"B","text":"the environment where most of a student's learning takes place"},{"letter":"C","text":"the assistance given to a student in their initial stages of learning"},{"letter":"D","text":"the setting of appropriate learning targets for a student's aptitude"}]}
      ]
    },
    {
      "type": "bank_fill",
      ...
      "instructions": "Complete the summary using the list of phrases, A-I, below.",
      "boxTitle": "Is streaming effective?",
      "bank": [
        {"letter":"A","text":"wrong classes"},
        {"letter":"B","text":"lower expectations"},
        {"letter":"C","text":"average learners"},
        {"letter":"D","text":"bottom sets"},
        {"letter":"E","text":"brightest pupils"},
        {"letter":"F","text":"disadvantaged backgrounds"},
        {"letter":"G","text":"weaker students"},
        {"letter":"H","text":"higher achievements"},
        {"letter":"I","text":"positive impressions"}
      ],
      "summary": [
        ...
        {"blank":32},
        {"text":", especially where a large proportion of them have"},
        {"blank":33},
        {"text":". Meanwhile, for the"},
        {"blank":34},
        {"text":", there appears to be only minimal advantage. A further issue is that teachers tend to have"},
        {"blank":35},
        {"text":"of students in streamed groups."}
      ]
    },
    {
      "type": "tfng",
      ...
      "items": [
        {"num":36,"text":"The Vygotsky model of education supports the concept of a mixed-ability class."},
        {"num":37,"text":"Some teachers are uncertain about allowing students to take on MKO roles in the classroom."},
        {"num":38,"text":"It can be rewarding to teach knowledge which you have only recently acquired."},
        {"num":39,"text":"The priority should be to ensure that the highest-achieving students attain their goals."},
        {"num":40,"text":"Taking part in collaborative outdoor activities with teachers and classmates can improve student outcomes in the classroom."}
      ]
    }
  ],
  "answerKey": {
    "1":"G","2":"D","3":"C","4":"F","5":"architects","6":"moisture","7":"layers","8":"speed","9":"C","10":"A","11":"B","12":"D","13":"A",
